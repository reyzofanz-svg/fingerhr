  ...
  return (
    ...
    >
      ...
      <div className="relative shrink-0">
        <div className={`h-20 w-20 rounded-full bg-gradient-to-br ${step.color} flex items-center justify-center shadow-lg`}
      ...
      <div className="flex-1 rounded-[2rem] p-8 glass group hover:border-white/15 transition-all duration-300">
        <div className={`inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${step.color} text-white mb-4`}>
          {step.icon}
        </div>
    ...
    <section className="relative px-6 py-24 max-w-[1440px] mx-auto">
      ...
      <div ref={headerRef} className="text-center mb-20 relative z-10">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-purple-500/20 bg-purple-500/5 mb-6"
        >
          <span className="font-mono text-xs text-purple-400 font-semibold tracking-wider">HOW IT WORKS</span>
        </motion.div>
      ...
      <div ref={containerRef} className="relative z-10 max-w-3xl mx-auto space-y-8">
        {/* Connecting line */}
        <div className="absolute left-[39px] top-10 bottom-10 w-px bg-gradient-to-b from-blue-500/30 via-purple-500/30 to-amber-500/30" />
