          ...
          <div className="flex-1">
            <div className="mb-2 flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary-container">
                <svg className="h-5 w-5 text-on-primary-container" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                </svg>
              </div>
              <div>
                <h1 className="text-xl font-bold text-on-surface">Absensi GPS</h1>
    ...
    <div className="fixed bottom-0 left-0 right-0 glass-strong border-t border-outline p-4">
      <div className="mx-auto max-w-md space-y-3">
        <button
          ...
          className="w-full rounded-xl bg-primary py-4 text-sm font-bold text-on-primary transition-all disabled:opacity-40 disabled:active:scale-100 active:scale-[0.98]"
        >
          {isSubmitting ? (
            <div className="flex items-center justify-center gap-3">
              <div className="loader" style={{ width: '16px', height: '16px', borderTopColor: 'var(--on-primary)', borderColor: 'rgba(0,0,0,0.2)' }} />
              Memproses absensi...
            </div>
          ) : (
        ...
        <button
          ...
          className="w-full rounded-xl bg-surface-container py-3 text-sm font-medium text-on-surface transition-all active:scale-[0.98]"
        >
          <div className="flex items-center justify-center gap-2">
