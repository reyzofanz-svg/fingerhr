        ...
        {showForm && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-md rounded-t-3xl bg-[#1a1a24] p-6"
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 text-sm text-white focus:border-blue-500 focus:outline-none"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full resize-none rounded-xl bg-white/5 border border-white/10 px-4 py-3 text-sm text-white placeholder-white/30 focus:border-blue-500 focus:outline-none"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 py-4 text-sm font-bold text-white shadow-lg shadow-blue-500/25 disabled:opacity-40 disabled:active:scale-100 active:scale-[0.98] transition-all"
                >
                  {submitting ? (
