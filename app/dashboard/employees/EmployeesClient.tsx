                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button
                          onClick={async () => {
                            if (confirm(`Reset device binding untuk ${emp.name}? Karyawan bisa login di device baru.`)) {
                              try {
                                ...
                                if (res.ok) {
                                  ...
                                  alert(data.error || "Gagal reset device");
                                }
                              } catch (error) {
                          ...
                          className="rounded-lg p-1.5 text-on-surface-variant hover:bg-yellow-500/10 hover:text-yellow-400"
                          title="Reset mobile device binding"
                        >
                          <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99" />
                          </svg>
